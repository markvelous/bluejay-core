...
interface ILedgerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "collateralTypes(address)": FunctionFragment;
...
export class ILedger extends BaseContract {
  ...
  functions: {
    ...
    debt(position: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  unbackedDebt(position: string, overrides?: CallOverrides): Promise<BigNumber>;
