...
const whenCoreDeployed = async ({ stabilityFee = DEFAULT_STABILITY_FEE, globalStabilityFee = ethers_1.BigNumber.from(0), } = {}) => {
    ...
    const collateralType = (0, utils_1.keccak256)(collateral.address);
    ...
    await ledger.updateDebtCeiling(collateralType, (0, utils_2.exp)(45).mul(1000000 * 1000));
    await ledger.updateDebtFloor(collateralType, (0, utils_2.exp)(45).mul(100));
    await ledger.updateTotalDebtCeiling((0, utils_2.exp)(45).mul(1000000 * 1000));
    await stablecoin.grantRole(MINTER_ROLE, stablecoinJoin.address);
    await oracle.setPrice((0, utils_2.exp)(18).mul(1500));
    await oracleRelayer.updateOracle(collateralType, oracle.address);
    await oracleRelayer.updateCollateralizationRatio(collateralType, (0, utils_2.exp)(27).mul(150).div(100));
    ...
    await accountingEngine.updateSurplusAuctionLotSize((0, utils_2.exp)(45).mul(100000));
    await accountingEngine.updateSurplusBuffer((0, utils_2.exp)(45).mul(500000));
    await accountingEngine.updateIntialDebtAuctionBid((0, utils_2.exp)(18).mul(1000));
    await accountingEngine.updateDebtAuctionLotSize((0, utils_2.exp)(45).mul(50000));
    ...
    await liquidationEngine.updateGlobalMaxDebtForActiveAuctions((0, utils_2.exp)(45).mul(100000000));
    await liquidationEngine.updateLiquidatonPenalty(collateralType, (0, utils_2.exp)(18).mul(113).div(100));
    await liquidationEngine.updateMaxDebtForActiveAuctions(collateralType, (0, utils_2.exp)(45).mul(20000000));
    ...
    await liquidationAuction.updateStartingPriceFactor((0, utils_2.exp)(27).mul(130).div(100));
    await liquidationAuction.updateMaxAuctionDuration(8400);
    await liquidationAuction.updateMaxPriceDiscount((0, utils_2.exp)(27).mul(40).div(100)); // TODO CHECK VALUE
    await liquidationAuction.updateKeeperRewardFactor((0, utils_2.exp)(18).div(1000));
    await liquidationAuction.updateKeeperIncentive((0, utils_2.exp)(45).mul(300));
    ...
    await discountCalculator.updateFactorPerStep((0, utils_2.exp)(27).mul(99).div(100)); // 0.99 per step
    // Account Initializations
    const [, account1, account2] = accounts;
    await collateral.mint(account1.address, (0, utils_2.exp)(18).mul(10000));
    await collateral.mint(account2.address, (0, utils_2.exp)(18).mul(10000));
    return {
        accounts,
        accountingEngine,
        collateral,
...
const depositCollateralAndDrawDebt = async ({ collateral, collateralJoin, ledger, account, collateralType, debtDrawn, collateralDeposit = (0, utils_2.exp)(18).mul(10000), }) => {
...
const whenDebtDrawn = async ({ debtDrawn = (0, utils_2.exp)(45).mul(10000 * 1000), stabilityFee, globalStabilityFee, } = {}) => {
    ...
    await depositCollateralAndDrawDebt({
        ...status,
        debtDrawn,
        collateralDeposit: (0, utils_2.exp)(18).mul(10000),
        account: account1,
    });
    return status;
};
describe("E2E", () => {
    it("should allow user to mint and withdraw stablecoin", async () => {
        ...
        await stablecoinJoin
            .connect(account1)
            .withdraw(account1.address, (0, utils_2.exp)(18).mul(10000 * 1000));
        // Should have the right amount of stablecoin
        (0, chai_1.expect)(await stablecoin.balanceOf(account1.address)).to.equal((0, utils_2.exp)(18).mul(10000 * 1000));
        // System parameters should be correct
        (0, chai_1.expect)(await ledger.totalDebt()).to.equal((0, utils_2.exp)(45).mul(10000 * 1000));
        (0, chai_1.expect)(await ledger.totalUnbackedDebt()).to.equal(0);
        // Collateral parameters should be correct
        const collateralData = await ledger.collateralTypes(collateralType);
        (0, chai_1.expect)(collateralData.normalizedDebt).to.equal((0, utils_2.exp)(18).mul(10000 * 1000));
    });
    it("should allow user to save (assuming zero stability fee)", async () => {
        ...
        await savingsAccount.connect(account1).deposit((0, utils_2.exp)(45)
            .mul(10000 * 1000 - 100)
            .div(DEFAULT_SAVINGS_RATE));
        // After one year
        await (0, utils_2.incrementTime)(60 * 60 * 24 * 365, hardhat_1.ethers.provider);
        await savingsAccount.connect(account1).updateAccumulatedRate();
        const totalDebt = await ledger.totalDebt();
        (0, chai_1.expect)(totalDebt).to.be.gt((0, utils_2.exp)(45).mul(10900000));
        (0, chai_1.expect)(totalDebt).to.be.lt((0, utils_2.exp)(45).mul(11000000));
        const totalUnbackedDebt = await ledger.totalUnbackedDebt();
        (0, chai_1.expect)(totalUnbackedDebt).to.be.gt((0, utils_2.exp)(45).mul(900000));
        (0, chai_1.expect)(totalUnbackedDebt).to.be.lt((0, utils_2.exp)(45).mul(1000000));
        // Withdraw savings
        ...
        (0, chai_1.expect)(accountBalance).to.be.gt((0, utils_2.exp)(45).mul(10900000));
        (0, chai_1.expect)(accountBalance).to.be.lt((0, utils_2.exp)(45).mul(11000000));
        const unbackedDebt = await ledger.unbackedDebt(accountingEngine.address);
        (0, chai_1.expect)(unbackedDebt).to.be.gt((0, utils_2.exp)(45).mul(900000));
        (0, chai_1.expect)(unbackedDebt).to.be.lt((0, utils_2.exp)(45).mul(1000000));
    });
    it("should allow stability fees to be collected", async () => {
        ...
        (0, chai_1.expect)(await ledger.debt(accountingEngine.address)).to.gt((0, utils_2.exp)(45).mul(1500000));
        // Transfer from debt from another account (simulating buy from ext account)
        await depositCollateralAndDrawDebt({
            ...status,
            debtDrawn: (0, utils_2.exp)(45).mul(10000 * 1000),
            collateralDeposit: (0, utils_2.exp)(18).mul(10000),
            account: account2,
        });
        await ledger
            .connect(account2)
            .transferDebt(account2.address, account1.address, (0, utils_2.exp)(45).mul(10000 * 1000 - 1));
        ...
        await collateralJoin
            .connect(account1)
            .withdraw(account1.address, (0, utils_2.exp)(18).mul(10000));
        (0, chai_1.expect)(await collateral.balanceOf(account1.address)).to.equal((0, utils_2.exp)(18).mul(10000));
        // Check that system parameters are correct
        const totalDebt = await ledger.totalDebt();
        (0, chai_1.expect)(totalDebt).to.lte((0, utils_2.exp)(45).mul(10000 * 1000));
        (0, chai_1.expect)(totalDebt).to.gt((0, utils_2.exp)(45).mul(10000 * 999));
        (0, chai_1.expect)(await ledger.totalUnbackedDebt()).to.equal(0);
        const collateralData = await ledger.collateralTypes(collateralType);
        const normalizedDebtCeil = Math.floor((10000 * 1000) / 1.14);
        const normalizedDebtFloor = Math.floor((10000 * 1000) / 1.16);
        (0, chai_1.expect)(collateralData.normalizedDebt).to.lte((0, utils_2.exp)(18).mul(normalizedDebtCeil));
        (0, chai_1.expect)(collateralData.normalizedDebt).to.gt((0, utils_2.exp)(18).mul(normalizedDebtFloor));
    });
    it("should allow unsafe positions to be liquidated", async () => {
        ...
        const [, account1, account2] = accounts;
        await oracle.setPrice((0, utils_2.exp)(18).mul(1250));
        await oracleRelayer.updateCollateralPrice(collateralType);
        ...
        (0, chai_1.expect)(lockedCollateralAcc1).to.equal(0);
        (0, chai_1.expect)(normalizedDebtAcc1).to.equal(0);
        // Debt is not touched for liquidated position
        (0, chai_1.expect)(await ledger.debt(account1.address)).to.equal((0, utils_2.exp)(45).mul(10000 * 1000));
        // Collateral goes to liquidation auction (unlocked)
        (0, chai_1.expect)(await ledger.collateral(collateralType, liquidationAuction.address)).to.equal((0, utils_2.exp)(18).mul(10000));
        // Reward credited for starting auction
        const reward = await ledger.debt(account2.address);
        (0, chai_1.expect)(reward).to.equal((0, utils_2.exp)(45)
            .mul(10000 * 1000)
            .mul(113)
            .div(100) // x 1.13 for liquidation penalty
            .div(1000)
            .add((0, utils_2.exp)(45).mul(300))); // Keeper incentive plus debtToRaise * keeperRewardFactor
        // Debt plus reward goes to accounting engine as unbacked debt
        (0, chai_1.expect)(await ledger.unbackedDebt(accountingEngine.address)).to.equal((0, utils_2.exp)(45)
            .mul(10000 * 1000)
            .add(reward));
        // Debt is pushed into accounting engine queue
        (0, chai_1.expect)(await accountingEngine.totalQueuedDebt()).to.equal((0, utils_2.exp)(45).mul(10000 * 1000));
        // Auction started
        const { debtToRaise, collateralToSell, position, startingPrice } = await liquidationAuction.auction(1);
        (0, chai_1.expect)(debtToRaise).to.equal((0, utils_2.exp)(45)
            .mul(10000 * 1000)
            .mul(113)
            .div(100));
        (0, chai_1.expect)(collateralToSell).to.equal((0, utils_2.exp)(18).mul(10000));
        (0, chai_1.expect)(position).to.equal(account1.address);
        (0, chai_1.expect)(startingPrice).to.equal((0, utils_2.exp)(27).mul(1250).mul(130).div(100));
        // Draw some debt for account 2
        const debtDrawnOnAcc2 = (0, utils_2.exp)(45).mul(10000 * 1500);
        await collateral.mint(account2.address, (0, utils_2.exp)(18).mul(100000));
        await depositCollateralAndDrawDebt({
            collateral,
            ledger,
            collateralJoin,
            ...
            collateralDeposit: (0, utils_2.exp)(18).mul(100000),
        });
        // Wait for liquidation price to drop
        await (0, utils_2.incrementTime)(1600, hardhat_1.ethers.provider);
        ...
        (0, chai_1.expect)(discountedPrice).to.be.closeTo((0, utils_2.exp)(27)
            .mul(1250)
            .mul(130)
            .div(100)
        ...
        (0, chai_1.expect)(collateralToSellAfterPartial).to.equal(collateralLeft.div(2));
        (0, chai_1.expect)(debtRequiredAfterPartial).to.equal(debtRequired.sub(collateralLeft.div(2).mul(discountedPrice)));
        ...
        (0, chai_1.expect)(lockedCollateralBeforeClose).to.equal(0);
        (0, chai_1.expect)(normalizedDebtBeforeClose).to.equal(0);
        // Liquidator has paid debt and collected collateral
        (0, chai_1.expect)(await ledger.debt(account2.address)).to.equal((0, utils_2.exp)(45).mul(15011600).sub(collateralLeft.div(2).mul(discountedPrice)));
        (0, chai_1.expect)(await ledger.collateral(collateralType, account2.address)).to.equal(collateralLeft.div(2));
        // // Full liquidation
        await liquidationAuction
            .connect(account2)
            .bidOnAuction(1, collateralLeft.div(2), discountedPrice, account2.address, "0x");
        // Liquidator paid all debt and received all collaterals
        (0, chai_1.expect)(await ledger.debt(account2.address)).to.equal((0, utils_2.exp)(45).mul(15011600).sub(debtRequired));
        (0, chai_1.expect)(await ledger.collateral(collateralType, account2.address)).to.equal(debtRequired.div(discountedPrice));
        // Liquidated position received remaining collateral as refunds
        (0, chai_1.expect)(await ledger.collateral(collateralType, account1.address)).to.equal(collateralLeft.sub(debtRequired.div(discountedPrice)));
    });
    it("should allow users to bid on surplus of debt collected from stability fee", async () => {
        ...
        const [, account1, account2] = accounts;
        await governanceToken.mint(account1.address, (0, utils_2.exp)(18).mul(150));
        await governanceToken
            .connect(account1)
            .approve(surplusAuction.address, ethers_1.constants.MaxUint256);
        await governanceToken.mint(account2.address, (0, utils_2.exp)(18).mul(300));
        await governanceToken
            .connect(account2)
            .approve(surplusAuction.address, ethers_1.constants.MaxUint256);
        await (0, utils_2.incrementTime)(60 * 60 * 24 * 365, hardhat_1.ethers.provider);
        ...
        (0, chai_1.expect)(activeAuctions.length).to.equal(1);
        (0, chai_1.expect)(activeAuctions[0]).to.equal(1);
        (0, chai_1.expect)(await surplusAuction.countActiveAuctions()).to.equal(1);
        const { debtToSell } = await surplusAuction.auctions(1);
        (0, chai_1.expect)(debtToSell).to.equal((0, utils_2.exp)(45).mul(100000));
        await surplusAuction
            .connect(account1)
            .placeBid(1, debtToSell, (0, utils_2.exp)(18).mul(150));
        (0, chai_1.expect)(await governanceToken.balanceOf(account1.address)).to.equal(0);
        (0, chai_1.expect)(await governanceToken.balanceOf(surplusAuction.address)).to.equal((0, utils_2.exp)(18).mul(150));
        const firstBid = await surplusAuction.auctions(1);
        (0, chai_1.expect)(firstBid.bidAmount).to.equal((0, utils_2.exp)(18).mul(150));
        (0, chai_1.expect)(firstBid.bidExpiry).to.not.equal(0);
        (0, chai_1.expect)(firstBid.highestBidder).to.equal(account1.address);
        await (0, utils_2.incrementTime)(640, hardhat_1.ethers.provider);
        await surplusAuction
            .connect(account2)
            .placeBid(1, debtToSell, (0, utils_2.exp)(18).mul(300));
        (0, chai_1.expect)(await governanceToken.balanceOf(account1.address)).to.equal((0, utils_2.exp)(18).mul(150));
        (0, chai_1.expect)(await governanceToken.balanceOf(account2.address)).to.equal(0);
        (0, chai_1.expect)(await governanceToken.balanceOf(surplusAuction.address)).to.equal((0, utils_2.exp)(18).mul(300));
        await (0, utils_2.incrementTime)(3 * 60 * 60 + 1, hardhat_1.ethers.provider);
        await surplusAuction.connect(account2).settleAuction(1);
        (0, chai_1.expect)(await governanceToken.balanceOf(surplusAuction.address)).to.equal(0);
        (0, chai_1.expect)(await governanceToken.totalSupply()).to.equal((0, utils_2.exp)(18).mul(150));
        (0, chai_1.expect)(await ledger.debt(account2.address)).to.equal(debtToSell);
        (0, chai_1.expect)(await surplusAuction.countActiveAuctions()).to.equal(0);
    });
    it("should allow users to bid on bad debt to earn governance token", async () => {
        ...
        await oracle.setPrice((0, utils_2.exp)(18).mul(1000));
        await oracleRelayer.updateCollateralPrice(collateralType);
        await liquidationEngine
            .connect(account2)
            .liquidatePosition(collateralType, account1.address, account2.address);
        (0, chai_1.expect)(await ledger.unbackedDebt(accountingEngine.address)).to.gt((0, utils_2.exp)(45).mul(10000000));
        // Get some stablecoin for account2
        await depositCollateralAndDrawDebt({
            ...status,
            debtDrawn: (0, utils_2.exp)(45).mul(100000),
            collateralDeposit: (0, utils_2.exp)(18).mul(10000),
            account: account2,
        });
        // Wait for queue
        await (0, utils_2.incrementTime)(561600 + 1, hardhat_1.ethers.provider);
        // Allow debt to be liquidated
        (0, chai_1.expect)(await accountingEngine.countPendingDebts()).to.equal(1);
        (0, chai_1.expect)((await accountingEngine.listPendingDebts())[0]).to.equal(1);
        await accountingEngine.popDebtFromQueue(1);
        (0, chai_1.expect)(await accountingEngine.countPendingDebts()).to.equal(0);
        // Start off some auctions (each with 50k of unbacked debts)
        (0, chai_1.expect)(await accountingEngine.totalDebtOnAuction()).to.equal(0);
        await accountingEngine.connect(account2).auctionDebt();
        await accountingEngine.connect(account2).auctionDebt();
        (0, chai_1.expect)(await accountingEngine.totalDebtOnAuction()).to.equal((0, utils_2.exp)(45).mul(100000));
        // Check that there are two ongoing auctions
        (0, chai_1.expect)(await debtAuction.countActiveAuctions()).to.equal(2);
        const activeAuctions = await debtAuction.listActiveAuctions();
        (0, chai_1.expect)(activeAuctions[0]).to.equal(1);
        (0, chai_1.expect)(activeAuctions[1]).to.equal(2);
        // Bid on the auctions
        (0, chai_1.expect)(await ledger.debt(account1.address)).to.equal((0, utils_2.exp)(45).mul(10000 * 1000));
        await debtAuction
            .connect(account1)
            .placeBid(1, (0, utils_2.exp)(18).mul(800), (0, utils_2.exp)(45).mul(50000));
        await debtAuction
            .connect(account1)
            .placeBid(2, (0, utils_2.exp)(18).mul(800), (0, utils_2.exp)(45).mul(50000));
        (0, chai_1.expect)(await ledger.debt(account1.address)).to.equal((0, utils_2.exp)(45)
            .mul(10000 * 1000)
            .sub((0, utils_2.exp)(45).mul(100000)));
        await (0, utils_2.incrementTime)(600, hardhat_1.ethers.provider);
        // Bid on auction from another account
        await debtAuction
            .connect(account2)
            .placeBid(1, (0, utils_2.exp)(18).mul(600), (0, utils_2.exp)(45).mul(50000));
        await debtAuction
            .connect(account2)
            .placeBid(2, (0, utils_2.exp)(18).mul(600), (0, utils_2.exp)(45).mul(50000));
        (0, chai_1.expect)(await ledger.debt(account1.address)).to.equal((0, utils_2.exp)(45).mul(10000 * 1000));
        // Settle the auction
        await (0, utils_2.incrementTime)(3 * 60 * 60, hardhat_1.ethers.provider);
        ...
        (0, chai_1.expect)(await ledger.unbackedDebt(accountingEngine.address)).to.lt((0, utils_2.exp)(45).mul(10000000));
        (0, chai_1.expect)(await governanceToken.balanceOf(account2.address)).to.equal((0, utils_2.exp)(18).mul(1200));
        (0, chai_1.expect)(await governanceToken.balanceOf(account1.address)).to.equal(0);
        (0, chai_1.expect)(await debtAuction.countActiveAuctions()).to.equal(0);
    });
});
