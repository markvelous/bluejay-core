...
export const Footer: FunctionComponent = () => {
  const linkLiquidityMining = useFeature("linkLiquidityMining");
  const linkBuyBlu = useFeature("linkBuyBlu");
  const navigation = {
    main: [
      { name: "Home", href: "/", external: false },
      ...(linkBuyBlu ? [{ name: "Buy BLU", href: "/buy-blu", external: false }] : []),
      ...(linkLiquidityMining
        ? [{ name: "Liquidity Mining", href: "https://mining.bluejay.finance/", external: true }]
        : []),
      { name: "Whitepaper", href: "https://docs.bluejay.finance/", external: true },
      { name: "Terms", href: "/terms", external: false },
    ],
    social: [
      {
        name: "Medium",
        href: "https://medium.com/bluejay-finance",
        icon: (
      ...
      {
        name: "Twitter",
        href: "https://twitter.com/BluejayFinance",
        icon: (
          <svg
            width="20px"
            height="20px"
      ...
      {
        name: "Telegram",
        href: "https://t.me/bluejayfinancecommunity",
        icon: (
          <svg
            width="24px"
            height="24px"
      ...
      {
        name: "Discord",
        href: "https://discord.gg/xFD78vJZ7f",
        icon: (
          <svg
            width="24px"
            height="24px"
          ...
          {navigation.main.map((item) => (
            <div key={item.name} className="px-5 py-2">
              <a
                ...
                rel="noreferrer"
                className="text-base text-white hover:text-blue-900"
              >
                {item.name}
              </a>
            </div>
