...
const buildDeploymentCache = (network, cache) => {
...
const buildTransactionCache = (network, cache) => {
    if (!(0, fs_1.existsSync)(cache))
        (0, fs_1.writeFileSync)(cache, "{}");
...
const buildCachedDeployments = ({ deploymentCachePath, transactionCachePath, network, skipDeploymentCache, skipTransactionCache, transactionOverrides = {}, }) => {
