...
interface SurplusAuctionLikeInterface extends ethers.utils.Interface {
  functions: {
...
export class SurplusAuctionLike extends BaseContract {
  ...
  interface: SurplusAuctionLikeInterface;
  ...
  callStatic: {
    ...
    shutdown(arg0: BigNumberish, overrides?: CallOverrides): Promise<void>;
