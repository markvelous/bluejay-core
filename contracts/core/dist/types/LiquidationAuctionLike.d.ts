...
interface LiquidationAuctionLikeInterface extends ethers.utils.Interface {
  functions: {
...
export class LiquidationAuctionLike extends BaseContract {
  ...
  interface: LiquidationAuctionLikeInterface;
